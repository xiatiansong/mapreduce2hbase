...
public class HBaseTemperatureCli extends Configured implements Tool {
	...
	public int run(String[] args) throws IOException {
		/*
		 * if (args.length != 1) {
		 * System.err.println("Usage: HBaseTemperatureCli <station_id>"); return
		 * -1; }
		 */
		...
		HTable table = new HTable(HBaseConfiguration.create(jc), "Observations");
		NavigableMap<Long, Integer> observations = getStationObservations(table, "011090-99999").descendingMap();
	...
	public static void main(String[] args) throws Exception {
		int exitCode = ToolRunner.run(HBaseConfiguration.create(), new HBaseTemperatureCli(), args);
